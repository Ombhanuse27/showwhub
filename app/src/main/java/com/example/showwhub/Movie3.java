...
public class Movie3 extends AppCompatActivity {
    ...
    private static final String movieName = "Joker:Folie a Deux"; // Static movie name

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_movie3); // Assuming you have a layout
    ...
    public void bookTicket(View view) {
        Intent intent = new Intent(Movie3.this, selectdt.class);
        intent.putExtra("movie_name", movieName); // Pass the movie name to the next activity
        startActivity(intent);
    }

    public void trailers(View view) {
        Intent i1=new Intent(Intent.ACTION_VIEW, Uri.parse("https://youtu.be/_OKAwz2MsJs?si=TvQhBiKBhBiRjV8u"));
        startActivity(i1);
